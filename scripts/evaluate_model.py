...
parser.add_argument('--D_type', default='rnn')
parser.add_argument('--dest', default='adv.txt', type=str)
#parser.add_argument('--dest', default='test', type=str)
...
def main(args):
    ...
    for path in paths:
        ...
        result_str = 'D_type: {}, Dataset: {}, Loss Weight: {:.2f} Pred Len: {}, ADE: {:.2f}, FDE: {:.2f} Samples: {} \n \n'.format(
                      args.D_type, _args.dataset_name, _args.l2_loss_weight, _args.pred_len, ade, fde, args.num_samples)
